...
person.firstName = "Ester Sangkoy";
person.adress = "Manado"

console.log(person);

//STRING LITERAL
// Hallo nama saya Ester, Umur 19 Tahun
...
console.log (sayHello3("Ester","Sangkoy"));

//DEFAULT PARAMETER
const defaultParameter =(param1,param2 = "Sangkoy",param3) => `Ini Default Param ${param1} ${param2}`
console.log(defaultParameter("Ester"));
